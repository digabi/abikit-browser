...
deb:
	...
	fpm -C deb-root/ -s dir --name abikit-browser --architecture native -t deb --version "1.1.$$BUILD_NUMBER" --depends python --depends python-setproctitle --depends python-pyqt5.qtwebkit --depends gstreamer1.0-plugins-good --depends gstreamer1.0-plugins-ugly --depends gstreamer1.0-libav .
